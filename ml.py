...
features_to_lag = ['volume','rsi', 'MACD_Cross_Power_Normalized', #'hash-rate',
                   'active-count', 'total_fee', 'transfer_count', 'yuan']
df = create_lag_features(df, features_to_lag, n_lags=3)
...
selected_features = [
    ...
    'rsi_lag_1', 'MACD_Cross_Power_Normalized_lag_1',
    'active-count_lag_1', 'total_fee_lag_1', 'transfer_count_lag_1',
    'close_ma_7', 'volume_ma_7',
